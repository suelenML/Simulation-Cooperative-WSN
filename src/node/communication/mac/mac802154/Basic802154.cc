...
void Basic802154::enviarNodosCooperantes(Basic802154Packet *beaconPacket){
    ...
    //cout<<"entrando no enviarNodosCooperantes\n";
...
void Basic802154::preencherDados(Basic802154Packet *macPacket) {
    //Modificação
    //fazer o for com iterator
    //slaves
    //cout<< "Prenchendo os dados-----";
    if (cooperador) {
        if (neigmap.size() > 0) {
...
void Basic802154::adicionarNodoSolto(int nodoConectado, int nodoSolto) {
    ...
    cout << "entrando no adicionarNodoSolto\n";
...
void Basic802154::selecionaNodosSmart(Basic802154Packet *beaconPacket) {
    ...
    cout << "Iniciando o selecionaNodosSmart ++++++++++++++++++++++";
...
//out << "C0: x0=0;\n";
        for (iterNeighborhood = neigmap.begin();
            ...
            if (nodo->numeroDevizinhos > 1) {
                //cout << "entrei no if nodo->numeroDevizinhos=="
                //        << nodo->numeroDevizinhos << "\n";
                primeiro = true;
...
//atulizar soma de rssi
    ...
    //   cout<<"saindo do Atualizar\n";
}
// método Ríad
void Basic802154::souNodoCooperante(Basic802154Packet * pkt) {
    // cout<<"entrando no souNodoCooperante\n";
    int i = 0;
    cooperador = false;   //não deveria ser necessário, mas por via das dúvidas.
...
void Basic802154::verificarRetransmissao(Basic802154Packet *rcvPacket) {
    //cout<<"entrando no verificarRetransmissao\n";
    int i;
...
void Basic802154::retransmitir(Basic802154Packet *nextPacket) {
    //  cout<<"entrando no retransmitir \n";
    if (nodosEscutados.size()) {
